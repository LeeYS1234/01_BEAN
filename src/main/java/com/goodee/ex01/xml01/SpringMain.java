...
public class SpringMain {
	...
	public static void main(String[] args) {
		...
		String resourceLocations ="classpath:xml/context01.xml"; // src/main/resources 아래 xml폴더에 저장된 contex01.xml을 의미한다.
		...
		// <bean>의 scope 이야기
		// 스프링이 만들어 놓은 <bean>을 여러번 요청하면
		// 매번 만들어 줄까? 아니면 하나만 만들어 놓고 계속 같은걸 줄까?
		// 확인해보면 하나만 만들어 놓고 계속 같은 걸 주는 것으로 볼 수 있다.
		...
		System.out.println(c1 == c2); // 참조값이 같은면 같은 객체라는 의미이다.
		
		// <bean>의 scope를 변경하려면
		// <bean> 태그에 scope 속성을 추가하면 된다.
		// context01.xml 파일을 열고 확이해보면 된다.
		// calculator2는 scope="prototype"으로 설정 했다.
